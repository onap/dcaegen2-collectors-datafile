 ...
 */
public final class MappedDiagnosticContents {
    ...
    private static final Logger logger = LoggerFactory.getLogger(MappedDiagnosticContents.class);

    private MappedDiagnosticContents() {}
