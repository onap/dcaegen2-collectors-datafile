...
public class FeedCreatorTest {
    ...
    private DmaapBusControllerReactiveHttpClient httpClientMock = mock(DmaapBusControllerReactiveHttpClient.class);
    ...
    public void executeWhenFeedCreated_returnsFeedUrls() throws Exception {
        ...
        StepVerifier.create(feedCreatorUnderTestSpy.execute(1, Duration.ofSeconds(0))) //
    ...
    void whenPassedObjectFits_firstFailsWithExceptionThenSucceeds() throws Exception {
        ...
        StepVerifier.create(feedCreatorUnderTestSpy.execute(2, Duration.ofSeconds(0))) //
                .expectNext(FEED_DATA) //
                .verifyComplete();
    }
