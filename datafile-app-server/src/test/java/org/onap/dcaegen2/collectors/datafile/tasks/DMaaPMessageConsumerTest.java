...
public class DMaaPMessageConsumerTest {
    ...
    private DMaaPMessageConsumer messageConsumerTask;
    ...
    public void whenPassedObjectDoesntFit_ThrowsDatafileTaskException() {
        ...
        StepVerifier.create(messageConsumerTask.getMessageRouterResponse()) //
                .expectSubscription() //
    ...
    private void prepareMocksForDmaapConsumer(String message, FileReadyMessage fileReadyMessageAfterConsume) {
        ...
        messageConsumerTask = spy(new DMaaPMessageConsumer(httpClientMock, jsonMessageParserMock));
    }
}
