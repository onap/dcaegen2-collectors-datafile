...
public class DMaaPMessageConsumerTest {
    ...
    private void prepareMocksForDmaapConsumer(Optional<JsonElement> message, FileReadyMessage fileReadyMessageAfterConsume) {
        ...
        if (message.isPresent()) {
            ...
            when(jsonMessageParserMock.getMessagesFromJson(any())).thenReturn(Flux.error(new DatafileTaskException("problemas")));
        }
