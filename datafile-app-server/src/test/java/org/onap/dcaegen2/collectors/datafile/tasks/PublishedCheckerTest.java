...
public class PublishedCheckerTest {
    ...
    public void executeWhenNotPublished_returnsFalse() throws Exception {
        ...
        verify(httpClientMock).getDmaapProducerResponseWithCustomTimeout(requestCaptor.capture(), anyInt());
    ...
    final void prepareMocksForTests(int responseCode, String content, Exception exception) throws Exception {
        ...
        if (exception == null) {
            when(httpClientMock.getDmaapProducerResponseWithCustomTimeout(any(HttpUriRequest.class), anyInt()))
