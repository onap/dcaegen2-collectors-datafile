...
public class SchedulerConfigTest {
    ...
    public void tryToStartTaskWhenNotStarted_success() {
        ...
        when(feedCreatorMock.createFeed(anyLong(), any(Duration.class), any(Map.class)))
                .thenReturn(Mono.just(FEED_DATA));
        ...
        verify(feedCreatorMock).createFeed(10, Duration.ofSeconds(5), contextMap);
