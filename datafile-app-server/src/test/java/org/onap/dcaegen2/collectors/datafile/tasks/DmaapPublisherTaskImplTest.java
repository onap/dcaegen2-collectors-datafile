...
class DmaapPublisherTaskImplTest {
    ...
    public static void setUp() {
        ...
        consumerDmaapModel = ImmutableConsumerDmaapModel.builder().productName(PRODUCT_NAME).vendorName(VENDOR_NAME)
                .lastEpochMicrosec(LAST_EPOCH_MICROSEC).sourceName(SOURCE_NAME).startEpochMicrosec(START_EPOCH_MICROSEC)
                .timeZoneOffset(TIME_ZONE_OFFSET).name(PM_FILE_NAME).location("target/" + PM_FILE_NAME)
