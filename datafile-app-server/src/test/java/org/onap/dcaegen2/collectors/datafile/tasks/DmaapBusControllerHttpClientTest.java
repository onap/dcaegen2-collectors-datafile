 ...
 */
public class DmaapBusControllerHttpClientTest {
    ...
    private DmaapBusControllerHttpClient controllerClientUnderTestSpy;
    ...
    void setUp() {
        ...
        controllerClientUnderTestSpy = spy(new DmaapBusControllerHttpClient(publisherConfigurationMock));
