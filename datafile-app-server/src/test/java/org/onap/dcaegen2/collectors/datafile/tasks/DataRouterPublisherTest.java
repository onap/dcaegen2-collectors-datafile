...
class DataRouterPublisherTest {
    ...
    public void whenPassedObjectFits_ReturnsCorrectStatus() throws Exception {
        ...
        verify(httpClientMock).getDmaapProducerResponse(requestCaptor.capture());
    ...
    public void whenPassedObjectFits_firstFailsThenSucceeds() throws Exception {
        ...
        verify(httpClientMock, times(2)).getDmaapProducerResponse(any(HttpUriRequest.class));
        verifyNoMoreInteractions(httpClientMock);
    }
    ...
    final void prepareMocksForTests(Exception exception, Integer firstResponse, Integer... nextHttpResponses)
        ...
        if (exception == null) {
            when(httpClientMock.getDmaapProducerResponse(any(HttpUriRequest.class))).thenReturn(httpResponseMock);
        } else {
            when(httpClientMock.getDmaapProducerResponse(any(HttpUriRequest.class))).thenThrow(exception)
