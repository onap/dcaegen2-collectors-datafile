...
class DataRouterPublisherTest {
    ...
    public void whenPassedObjectFits_ReturnsCorrectStatus() throws Exception {
        ...
        StepVerifier
                .create(publisherTaskUnderTestSpy.execute(consumerDmaapModel, FEED_DATA, 1, Duration.ofSeconds(0),
                        CONTEXT_MAP))
    ...
    void whenPassedObjectFits_firstFailsWithExceptionThenSucceeds() throws Exception {
        ...
        StepVerifier
                .create(publisherTaskUnderTestSpy.execute(consumerDmaapModel, FEED_DATA, 2, Duration.ofSeconds(0),
                        CONTEXT_MAP))
                .expectNext(consumerDmaapModel) //
                .verifyComplete();
    }
