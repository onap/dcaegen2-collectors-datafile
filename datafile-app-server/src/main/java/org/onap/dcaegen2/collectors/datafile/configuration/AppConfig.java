/*-
 * ============LICENSE_START=======================================================
* NOKIA Intellectual Property, 2018-2019 Nordix Foundation. All rights reserved.
 * ================================================================================
...
public class AppConfig {
    ...
    private DmaapBusControllerConfiguration dmaapBusControllerConfiguration;
    ...
    public synchronized DmaapBusControllerConfiguration getDmaapBusControllerConfiguration() {
    ...
    public void loadConfigurationFromFile() {
        ...
        try (InputStream inputStream = createInputStream(filepath)) {
            ...
            if (rootElement.isJsonObject()) {
                ...
                DmaapBusControllerConfiguration busControllerConfiguration = deserializeType(gsonBuilder,
                        concatenateJsonObjects(
                                jsonObject.getAsJsonObject(CONFIG).getAsJsonObject(DMAAP)
                                        .getAsJsonObject(DMAAP_BUSCONTROLLER),
                                rootElement.getAsJsonObject().getAsJsonObject(CONFIG).getAsJsonObject(SECURITY)),
                        DmaapBusControllerConfiguration.class);

                setConfiguration(busControllerConfiguration, consumerConfiguration, ftpesConfig);
            }
        } catch (IOException e) {
    ...
    synchronized void setConfiguration(DmaapBusControllerConfiguration busControllerConfiguration,
            DmaapConsumerConfiguration consumerConfiguration, FtpesConfig ftpesConfig) {
        this.dmaapBusControllerConfiguration = busControllerConfiguration;
