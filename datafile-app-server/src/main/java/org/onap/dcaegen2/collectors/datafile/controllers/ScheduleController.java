...
public class ScheduleController {
    ...
    public Mono<ResponseEntity<String>> startTasks(@RequestHeader HttpHeaders headers) {
        MdcVariables.initializeTraceContext(headers);
        logger.info(MdcVariables.ENTRY, "Start request");
        Mono<ResponseEntity<String>> response = startTasks();
        logger.info(MdcVariables.EXIT, "Start request");
        return response;
    }
