    ...
    public void collectFile(String remoteFile, Path localFile) throws DatafileTaskException {
        ...
        try {
            ...
            if (retry) {
                ...
                throw new NonRetryableDatafileTaskException("Unable to get file from xNF. No retry attempts will be done. Data: " + fileServerData, e);
            }
        }
    ...
    public void open() throws DatafileTaskException {
        try {
            ...
            if (retry) {
                ...
                throw new NonRetryableDatafileTaskException("Could not open Sftp client, no retry attempts will be done " + e);
            }
        }
    }
