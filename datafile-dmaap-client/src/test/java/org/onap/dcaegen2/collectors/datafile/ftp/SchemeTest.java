...
public class SchemeTest {
    @Test
    public void getSchemeFromString_properScheme( ) {
        try {
    ...
    public void getSchemeFromString_invalidScheme() {
        try {
            Scheme.getSchemeFromString("invalid");
            fail("Should have thrown exception");
        } catch (DatafileTaskException e) {
            assertTrue(e.getMessage().startsWith("DFC does not support protocol invalid"));
        }
    }
}
